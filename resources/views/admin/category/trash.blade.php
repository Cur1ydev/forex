                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Danh sách các danh mục đã xóa</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                                ...
                                <div class="listjs-table" id="customerList">
                                    <div class="row g-4 mb-3">
                                        <div class="col-sm-auto">
                                            <div>
                                                <a href="{{route('admin.category.list')}}" class="btn btn-success add-btn"><i
                                                        class="ri-add-line align-bottom me-1"></i> Danh sách
                                                </a>
                                                <a href="{{route('admin.category.allTrash')}}" class="btn btn-success add-btn"><i
                                        ...
                                        <table class="table align-middle table-nowrap" id="customerTable">
                                            ...
                                            @foreach($trash as $tr)
                                                <tr align="center">
                                                    ...
                                                    <td>{{empty($tr->parent)?'Không':$tr->parent->name}}</td>
                                                    <td>
                                                        <div class="d-flex gap-2">
                                                            <div class="edit">
                                                                <a href="{{route('admin.category.onlyTrash',['id' => $tr->id])}}" class="btn btn-success add-btn"><i
