                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Danh sách các trang đã xóa</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                                ...
                                <div class="listjs-table" id="customerList">
                                    <div class="row g-4 mb-3">
                                        <div class="col-sm-auto">
                                            <div>
                                                <a href="{{route('admin.blog.list')}}" class="btn btn-success add-btn"><i
                                                        class="ri-add-line align-bottom me-1"></i> Danh sách
                                                </a>
                                                <a href="{{route('admin.blog.allTrash')}}" class="btn btn-success add-btn"><i
                                    ...
                                    <div class="table-responsive table-card mt-3 mb-1">
                                        <table class="table align-middle table-nowrap" id="customerTable">
                                            ...
                                            @foreach($trash as $tr)
                                                <tr align="center">
                                                    <td class="customer_name">{{$tr->name}}
                                                    </td>
                                                    <td class="email">{{$tr->content}}</td>
                                                    <td><img src="{{asset($tr->images)}}"
                                                             alt="{{asset($tr->images)}}"
                                                             width="50%"></td>
                                                    <td class="customer_name">{{$tr->author}}</td>
                                                    <td class="customer_name">{{$tr->short_description}}</td>
                                                    <td>
                                                        <div class="d-flex gap-2">
                                                            <div class="edit">
                                                                <a href="{{route('admin.blog.onlyTrash',['id' => $tr->id])}}" class="btn btn-success add-btn"><i
